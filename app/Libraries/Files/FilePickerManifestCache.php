...
/**
 * Versioned cache for the file picker read model.
 *
 * A version key avoids enumerating cache keys when a file mutation changes
 * the visible library. Old entries expire normally and become unreachable
 * immediately after the version is bumped.
 */
